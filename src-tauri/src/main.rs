...
/// Configure Linux environment and apply Steam Deck-specific fixes
fn configure_linux_environment() {
    ...
    // Apply Steam Deck-specific fixes
...
fn main() {
    ...
    // Linux environment setup (WebKit fixes + Steam Deck detection)
